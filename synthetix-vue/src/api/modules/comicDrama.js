...
export const comicDramaApi = {
  ...
  generatePanelImage: (id, data) => request.post(`/api/comic-projects/${id}/panels/generate-image`, data, { timeout: 120000 }),
  uploadPanelImage: (id, panelIndex, formData) => request.post(`/api/comic-projects/${id}/panels/upload-image?panel_index=${panelIndex}`, formData),
  generatePanelVideo: (id, data) => request.post(`/api/comic-projects/${id}/panels/generate-video`, data, { timeout: 300000 }),
