...
from src.service.fish_speech.fish_speech.utils.file import (
    AUDIO_EXTENSIONS,
    audio_to_bytes,
    list_files,
    read_ref_text,
)
from src.service.fish_speech.fish_speech.utils.schema import ServeReferenceAudio
...
class ReferenceLoader:
    ...
    def __init__(self) -> None:
        ...
        # 新版本 torchaudio 已移除 list_audio_backends，直接使用 soundfile
        try:
            # 尝试使用 soundfile backend
    ...
    def load_audio(self, reference_audio, sr):
        """
        Load the audio service from a file or bytes.
        """
