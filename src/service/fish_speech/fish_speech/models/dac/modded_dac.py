...
class DAC(BaseModel, CodecMixin):
    ...
    def encode(
        ...
        **kwargs,
        ...
        """Encode given audio service and return quantized latent codes

        Parameters
        ----------
        audio_data : Tensor[B x T]
            Audio service to encode
    ...
    def forward(
        ...
        **kwargs,
        ...
        sample_rate : int, optional
            Sample rate of audio service in Hz, by default None
