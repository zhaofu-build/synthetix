...
import torch
from src.service.sovits_v4.text.LangSegmenter import LangSegmenter
...
import librosa
import numpy as np
from src.service.sovits_v4.feature_extractor import cnhubert
...
from src.service.sovits_v4.module.models import SynthesizerTrn, SynthesizerTrnV3, Generator
...
from src.service.sovits_v4.AR.models.t2s_lightning_module import Text2SemanticLightningModule
from peft import LoraConfig, get_peft_model
from src.service.sovits_v4.text import cleaned_text_to_sequence
from src.service.sovits_v4.text.cleaner import clean_text

from src.service.sovits_v4.tools.i18n.i18n import I18nAuto, scan_language_list
...
from src.service.sovits_v4.process_ckpt import get_sovits_version_from_path_fast, load_sovits_new
...
def change_sovits_weights(sovits_path, prompt_language=None, text_language=None):
    ...
    if prompt_language is not None and text_language is not None:
        ...
        yield (
            ...
            {"__type__": "update", "visible": visible_sample_steps, "value": 32 if model_version == "v3" else 8,
...
def change_gpt_weights(gpt_path):
    ...
    max_sec = config["service"]["max_sec"]
...
def get_spepc(hps, filename):
    # audio = load_audio(filename, int(hps.service.sampling_rate))
...
from src.service.sovits_v4.text import chinese
...
from src.service.sovits_v4.module.mel_processing import mel_spectrogram_torch, spectrogram_torch
