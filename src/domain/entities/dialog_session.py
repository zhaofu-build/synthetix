...
class DialogSession(Base):
    ...
    status = Column(String(20), default="idle", index=True, comment="状态: idle/collecting/confirming/executing/completed/error")
    ...
    current_video_id = Column(Integer, nullable=True, index=True, comment="当前视频 ID")
