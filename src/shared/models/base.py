...
class BaseReq(BaseModel):
    ...
    ref_wav_path: Optional[str] = Field(None, description="参考音频路径")
    ...
    sourceAudioPath: Optional[str] = Field(None, description="源音频路径")
    accompanimentUrl: Optional[str] = Field(None, description="伴奏URL")
    # 更新相关
    video_name: Optional[str] = Field(None, description="视频名称")
    web_path: Optional[str] = Field(None, description="Web路径")
    local_path: Optional[str] = Field(None, description="本地路径")
    duration: Optional[str] = Field(None, description="时长")
    duration_hms: Optional[str] = Field(None, description="时长(HH:MM:SS)")
    description: Optional[str] = Field(None, description="描述")
    del_flag: Optional[int] = Field(None, description="删除标志")
